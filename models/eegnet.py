...
class eegNet(nn.Module):
    ...
    def calculateOutSize(self, model, nChan, nTime):
        ...
        print("First blocks out shape:", out)
        return out[2:]
    ...
    def __init__(self, nChan, nTime, nClass = 2,
        ...
        # self.lastLayer = self.lastBlock(self.F2, nClass, (1, 7))
